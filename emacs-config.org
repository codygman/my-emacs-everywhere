...
(defun my-exwm-workspace-switch-to-buffer (orig-func buffer-or-name &rest args)
  (when buffer-or-name
   ...
   (define-key exwm-mode-map [?\s-b] #'helm-mini)
...
**** code
:PROPERTIES:
:ID:       94c0a9ff-ea2d-4938-8504-f05e67eed3f6
:END:
#+begin_src emacs-lisp
  ...
  :END:
  ,** TODO plan project
  ,** TODO project retrospective [/]
  ,*** TODO what went well?
  ,*** TODO what could have went better?
  ,*** TODO how will you improve next time?"
             :prepend t
             ;; :clock-in t ;; TODO add a planning part and clock into that
             )
  ...
  (use-package all-the-icons
    ...
    (cond
     ((string-equal system-type "gnu/linux")
      (if (not
        (file-exists-p (concat (getenv "XDG_CONFIG_HOME") "/fonts/all-the-icons.ttf")))
